#include <assert.h>                         // assert(b) ger felmeddelande om b false
...
/*
   ...
   // s2.push_back("55");
    ...
    assert(v.size() == 1);  
    v.push_back(4.5);    // nu ligger ett element i vektorn
    ...
    */
    /*assert(v[0] == 2.10 &&      // hamnade de rätt?
	   v[1] == 3.14);  */     
   // cout << "v[0]: " << v[0] << endl << "v[1]: " << v[1] << endl << "v[2]: " << v[2] << endl;
